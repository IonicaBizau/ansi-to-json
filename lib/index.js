...
Ansi_Up.prototype.process = function (txt, options, markup) {
  ...
  var color_chunks = raw_text_chunks.map(function (chunk) {
    return self.process_chunk(chunk, options, markup) || null;
  }).filter(Boolean);
...
Ansi_Up.prototype.process_chunk = function (text, options, markup) {
    ...
    if ((self.fg === null) && (self.bg === null)) {
        ...
        debugger
        result.html.styles = styles;
        result.attributes = render_data.call(self, data);
 ...
 */
module.exports = function ansiToJson (input) {
    var a2h = new Ansi_Up();
    return a2h.process(input, {}, true);
};
